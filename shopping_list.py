...
def remove_shopping_list(lists_by_name, list_name_to_remove):
    ...
    Returns:
      None
    """
    whatToRemove = raw_input('which list to remove? ')
    # target

    if whatToRemove in lists_by_name:
        del lists_by_name[whatToRemove]
    else:
...
def add_to_shopping_list(lists_by_name, list_name, items):
    ...
    list_name = []
    items = raw_input('Please enter items separated by commas: ')
...
def remove_from_shopping_list(lists_by_name, list_name, items):
    ...
    list_name = []
    itemsToRemove = raw_input('Please enter items separated by commas: ')
   
    if lists_by_name.get(itemsToRemove):
        del itemsToRemove
